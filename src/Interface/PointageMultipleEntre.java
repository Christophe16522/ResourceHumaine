    ...
    public PointageMultipleEntre() {
        ...
        table = new JTable(model) {
            ...
            public void setValueAt(Object aValue, int row, int column) {
                ...
                if(column==3||column==5||column==7||column==9||column==11||column==13||column==15){
                    try {
                ...
                if(column==3||column==5||column==7||column==9||column==11||column==13||column==15){
                  // exception mety  //int sommeRetardMin =Integer.parseInt(getValueAt(row, 0).toString())+Integer.parseInt(getValueAt(row, 0).toString());
                    int sommeRetardMin =Integer.parseInt(getValueAt(row, 3).toString())+Integer.parseInt(getValueAt(row, 5).toString());
                    
                        setValueAt(String.valueOf(sommeRetardMin), row, 16);
            ...
            case "OK":
                try {
                    ...
                    //for (int i = 2; i < 14; i++) {
                            ...
                            columnNames[2] = dates[0].toString();
                            columnNames[4] = dates[1].toString();
                            columnNames[6] = dates[2].toString();
                            columnNames[8] = dates[3].toString();
                            columnNames[10] = dates[4].toString();
                            columnNames[12] = dates[5].toString();
                            columnNames[14] = dates[6].toString();
                            columnNames[16] = dates[7].toString();
